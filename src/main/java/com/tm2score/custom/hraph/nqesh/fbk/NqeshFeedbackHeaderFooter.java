 ...
 * @author Mike
 */
public class NqeshFeedbackHeaderFooter extends PdfPageEventHelper
{
    ...
    public NqeshFeedbackHeaderFooter( Document d , Locale l, String t, ReportData rd, ReportSettings rs, Image custLogo ) throws Exception
    {
        reportData = rd;
        ...
        {
            title = "Test Results and Development Guide";//  lmsg( "g.TestResultsAndInterviewGuide", new String[]{ Integer.toString( c.get( Calendar.YEAR) ) } );
    ...
    private PdfPTable getHeaderTable( boolean dark )
    {
        ...
        try
        {
            ...
            //LogoCell
            PdfPCell c = reportData.getReportRuleAsBoolean( "hidehralogoinreports") ? new PdfPCell( new Phrase("") ) : new PdfPCell( reportSettings.getHraLogoWhiteTextSmall() );
