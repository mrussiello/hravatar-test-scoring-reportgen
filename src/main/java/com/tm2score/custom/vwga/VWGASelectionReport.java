 ...
 * @author Mike
 */
public class VWGASelectionReport extends BaseVWGAReportTemplate implements ReportTemplate
{

    public VWGASelectionReport()
    {
        super();
    }
    ...
    public byte[] generateReport() throws Exception
    {
        ...
        {
            LogService.logIt( e, "VWGASelectionReport.generateReport() " );
