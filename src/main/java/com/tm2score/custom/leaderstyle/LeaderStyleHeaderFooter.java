 ...
 * @author Mike
 */
public class LeaderStyleHeaderFooter extends PdfPageEventHelper
{
    ...
    public LeaderStyleHeaderFooter( Document d , Locale l, String t, ReportData rd, ReportSettings rs, Image custLogo, String[] feedbackReportFooterImageUrls ) throws Exception
    {
        reportData = rd;
