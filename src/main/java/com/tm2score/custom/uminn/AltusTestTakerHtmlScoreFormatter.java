 ...
 * @author miker_000
 */
public class AltusTestTakerHtmlScoreFormatter extends UMinnTestTakerHtmlScoreFormatter {
    
    public AltusTestTakerHtmlScoreFormatter()
    {
        super();
    }
    ...
    public Object[] getStandardHeaderSection( boolean tog, boolean includeTop, String topNoteHtml, String introLangKey, String customMsg )
    {
        ...
        StringBuilder sb = new StringBuilder();
            ...
            if( includeTop )
            {
                ...
                sb.append( "<tr style=\"background-color:#7a0019\"><td style=\"background-color:#4C55A5;padding-top:8px;padding-left:8px;padding-right:4px;vertical-align:middle\">" + 
                                "<img src=\"https://cdn.hravatar.com/web/orgimage/Q8vQJ8K3q0E-/img_31x1639434689762.png\" width=\"120\" alt=\"Altus Assessments Logo\"/></td>" +
                               "<td colspan=\"4\" style=\"font-weight:bold;vertical-align:top;color:white;background-color:#4C55A5;padding:2px;vertical-align:middle;font-size:14pt;font-weight:bold\"><div style=\"font-size:18pt;padding-top:5px;padding-bottom:2px\"></div><div>Altus Developmental SJT</div></td></tr>\n" );
