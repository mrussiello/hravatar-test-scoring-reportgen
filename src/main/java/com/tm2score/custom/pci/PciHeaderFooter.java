 ...
 * @author Mike
 */
public class PciHeaderFooter extends PdfPageEventHelper
{
    ...
    public float HEADER_TITLE_PADDING_Y = 0;
    ...
    public PciHeaderFooter( Document d , Locale l, String t, ReportData rd, ReportSettings rs ) throws Exception
    {
        reportData = rd;
        ...
        if( headerLogo == null )
            headerLogo = ITextUtils.getITextImage( com.tm2score.util.HttpUtils.getURLFromString( RuntimeConstants.getStringValue( "baseurl" ) + "/resources/images/pci/pci-logo-purple-54.png" ) );
    ...
    public void init( PdfWriter w ) throws Exception
    {
        if( HEADER_HEIGHT == 0 )
        {
            ...
            HEADER_TITLE_PADDING_Y = (HEADER_HEIGHT - HEADER_TITLE_HEIGHT)/2 - 10;
    ...
    private PdfPTable getHeaderTable( boolean dark )
    {
        ...
        try
        {
            ...
            c.setVerticalAlignment( Element.ALIGN_TOP );
            c.setPadding( 1 );
            c.setPaddingTop( HEADER_TITLE_PADDING_Y );
            t.addCell( c );
