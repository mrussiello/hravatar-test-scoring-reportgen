...
public class LeaderTestTakerHtmlScoreFormatter extends BaseScoreFormatter implements ScoreFormatter
{
    ...
    public String getEmailContent( boolean tog, boolean includeTop, String topNote) throws Exception
    {
        try
        {
            ...
            LogService.logIt( "LeaderTestTakerHtmlScoreFormatter.getEmailContent() " );
        ...
        {
            LogService.logIt( e, "LeaderTestTakerHtmlScoreFormatter.getEmailContent() " );
    ...
    public String getEmailSubj() throws Exception
    {
        ...
        return lmsg(  "g.LeaderTestTakerFeedbackEmailSubj" , params);
    }
