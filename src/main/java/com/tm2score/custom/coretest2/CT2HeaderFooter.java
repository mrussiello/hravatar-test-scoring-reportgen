 ...
 * @author Mike
 */
public class CT2HeaderFooter extends PdfPageEventHelper
{
    ...
    public CT2HeaderFooter( Document d , Locale l, String t, ReportData rd, ReportSettings rs, Image custLogo ) throws Exception
    {
        reportData = rd;
